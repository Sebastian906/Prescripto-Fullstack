...
const Login = () => {
    ...
    return (
        <form className="min-h-[80vh] flex items-center">
            <div className="flex flex-col gap-3 m-auto items-start p-8 min-w-85 sm:min-w-96 border border-zinc-300 outline-none rounded-xl text-zinc-600 text-sm shadow-lg">
                ...
                <button className="bg-indigo-500 text-slate-50 w-full py-2 rounded-md text-base">
