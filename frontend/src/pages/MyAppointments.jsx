                    ...
                    >
                        ...
                        <div className="flex flex-col gap-2 justify-end">
                            {!item.cancelled && <button
                                className="text-sm text-stone-500 text-center sm:min-w-48 py-2 border rounded hover:bg-indigo-500 hover:text-white transitional-all duration-300 cursor-pointer">
                                Pay Online
                            </button>}
                            {!item.cancelled && <button
                                onClick={() => cancelAppointment(item._id)}
                                className="text-sm text-stone-500 text-center sm:min-w-48 py-2 border rounded hover:bg-red-600 hover:text-white transitional-all duration-300 cursor-pointer">
                                Cancel appointment
                            </button>}
                            {item.cancelled && <button
                                className="sm:min-w-48 py-2 border border-red-600 rounded text-red-600">
