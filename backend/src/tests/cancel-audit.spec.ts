...
describe('cancel writes exactly one AuditLog entry per role', () => {
    ...
    it('user cancel → 1 record', async () => {
        ...
        const svc = new AppointmentsService(appointmentModel, doctorModel, {} as any, connection, {} as any, reportsService);
        (svc as any).auditService = auditService;
    ...
    it('doctor cancel → 1 record', async () => {
        ...
        const svc = new DoctorsService(doctorModel, appointmentModel, {} as any, {} as any, reportsService);
        (svc as any).auditService = auditService;
    ...
    it('admin cancel → 1 record', async () => {
        ...
        const svc = new AdminService(doctorModel, appointmentModel, {} as any, {} as any, {} as any, {} as any, {} as any, {} as any);
        (svc as any).auditService = auditService;
