...
export class SpecialitiesController {
  ...
  @Get('names')
  @ApiOperation({
    summary: 'Get flat list of active speciality names for form selects',
  })
  async getNames() {
  ...
  @Get('resolve/:slug')
  @ApiOperation({
    summary: 'Resolve all descendant slugs for a given speciality',
  })
  ...
  @ApiHeader({ name: 'atoken', required: true })
  @UseGuards(AuthAdminGuard)
  async update(@Param('id') id: string, @Body() dto: UpdateSpecialityDto) {
