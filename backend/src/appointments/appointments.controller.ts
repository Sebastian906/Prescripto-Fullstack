...
export class AppointmentsController {
  ...
  async bookAppointment(@Req() req: Request, @Body() dto: BookAppointmentDto) {
  ...
  @UseGuards(AuthUserGuard)
  async payWithCOD(@Req() req: Request, @Body() dto: PaymentCODDto) {
    const userId = (req as any).userId as string;
  ...
  @UseGuards(AuthUserGuard)
  async payWithStripe(@Req() req: Request, @Body() dto: PaymentStripeDto) {
    const userId = (req as any).userId as string;
