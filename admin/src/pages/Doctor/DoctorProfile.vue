...
<template>
    <div v-if="profileData && profileData.address" class="flex flex-col gap-4 m-5">
        <div>
            <img
                class="bg-indigo-500/80 w-full sm:max-w-64 rounded-lg object-cover"
        ...
        <div class="flex-1 border border-stone-200 rounded-lg p-8 py-7 bg-indigo-50">
            ...
            <div class="mt-3">
                <p class="text-sm font-medium text-neutral-800">About:</p>
            ...
            <div class="flex gap-2 py-2 text-gray-600">
                <p class="font-medium shrink-0">Address:</p>
            ...
            <div class="flex items-center gap-2 pt-2">
                <input
                    type="checkbox"
                    id="available"
                    :checked="isEdit ? localAvailable : profileData.available"
                    :disabled="!isEdit"
                    @change="isEdit && (localAvailable = !localAvailable)"
                />
                <label for="available" class="text-gray-600 text-sm">Available</label>
            </div>
