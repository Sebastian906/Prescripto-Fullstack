...
<template>
    <div class="flex items-center justify-center min-h-screen bg-indigo-100">
        <div class="bg-white rounded-2xl shadow-xl px-10 py-10 w-full max-w-md mx-4">
            <h1 class="text-3xl font-semibold text-slate-800 text-center mb-1">Reset Password</h1>
            <p class="text-sm text-slate-500 text-center mb-7">Enter your new password below.</p>
